                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                        ...
                        <p className="text-2xl font-bold text-green-600">
                            {progress.successfulMints}
                        </p>
                    </div>
                    <div>
                        <p className="text-muted-foreground">Failed</p>
                        <p className="text-2xl font-bold text-red-600">
                            {progress.failedMints}
                        </p>
                    </div>
                </div>
                    ...
                    <div className="pt-4 border-t space-y-3">
                        ...
                        <Alert>
                            <AlertDescription className="text-xs">
                                <strong>About ZK Compression:</strong> Compressed token accounts are stored in Merkle trees on the ledger, 
                                making them ~5000x cheaper than regular SPL tokens. Individual transaction signatures won't show token 
                                accounts on standard explorers - use the mint address above to see activity, or query balances via 
                                the ZK Compression RPC indexer.
                            </AlertDescription>
                        </Alert>
                    </div>
                )}
